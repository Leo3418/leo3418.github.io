...
![Stats in the Character Creator]({{< static-path type=img file=char-creator-stats.png l10n=y >}})
...
1. Start a Mission where Wanted Levels are disabled, such as Pier Pressure.
   ...
   menu]({{< static-path type=img file=mission-selection.png l10n=y >}})

2. Go to the Vanilla Unicorn strip club.

   ![Location of Vanilla Unicorn]({{< static-path type=img file=vanilla-unicorn.png l10n=y >}})

3. Use a vehicle to block the front door.

   ![Blocking the front door]({{< static-path type=img file=front-door.png l10n=y >}})

4. Use another vehicle to block the rear door.

   ![Blocking the rear door]({{< static-path type=img file=rear-door.png l10n=y >}})
