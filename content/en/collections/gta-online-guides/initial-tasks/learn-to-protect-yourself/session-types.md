...
![Choose "Play GTA Online"]({{< static-path type=img file=play-online.png l10n=y >}})

![Select session type]({{< static-path type=img file=session-types.png l10n=y >}})
...
![A Public Session]({{< static-path type=img file=public-session.png l10n=y >}})

![An Invite Only
Session]({{< static-path type=img file=invite-only-session.png l10n=y >}})
