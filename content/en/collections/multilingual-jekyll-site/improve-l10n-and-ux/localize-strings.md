...
![Strings not being translated]({{< static-path img not-translated.png >}})
...
!["subscribe via RSS" is now translated]({{< static-path img rss-subscribe-translated.png >}})
...
![List title changed to new value]({{< static-path img list-title-changed.png >}})
...
![Localized list title]({{< static-path img list-title-localized.png >}})
