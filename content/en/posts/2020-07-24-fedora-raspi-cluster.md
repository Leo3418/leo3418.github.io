...
![The cluster set up with PoE]({{< static-path img hardware-setup.png >}})
...
{{< static-path res arm-image-installer.cast >}}
{{< /asciicast >}}
...
![The configuration interface of my router]({{< static-path img router-config.png >}})

Once you get the Raspberry Pi's IP address, log in via SSH using the `root`
user.

{{< asciicast poster="npt:5" >}}
{{< static-path res init-ssh-con.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:4.8" >}}
{{< static-path res hostname.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:4.7" >}}
{{< static-path res wifi-con.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:23.7" startAt=20 >}}
{{< static-path res view-ip-addr.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:2.7" startAt=20 >}}
{{< static-path res connect-via-wifi.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:15" >}}
{{< static-path res firewall.cast >}}
{{< /asciicast >}}
...
{{< static-path res create-user.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:8" startAt=8 >}}
{{< static-path res allow-sudo.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:5.3" >}}
{{< static-path res install-mpi.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:10.5" >}}
{{< static-path res set-mpi-path.cast >}}
{{< /asciicast >}}
...
{{< static-path res rm-sudo-passwd.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:16" >}}
{{< static-path res ssh-key-w2m.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:15" >}}
{{< static-path res ssh-key-m2w.cast >}}
{{< /asciicast >}}
...
{{< asciicast poster="npt:21" >}}
{{< static-path res run-mpiexec.cast >}}
{{< /asciicast >}}
